...
public class TrabalhoMJV {
	...
	public static void main(String[] args) throws IOException {
		...
		/**
		 * Adicionar 2 novos métodos aqui
		 * 
		 * @author marcklen
		 */

		// Comparando 2 arquivos para saberem se são copias exatas
		long mismatchfiles = Files.mismatch(arquivo, caminho);
		if (mismatchfiles == -1) {
		...
		byte[] b = Files.readAllBytes(caminho);
	...
	public static void existeTamanho(Path arquivo) {
		...
		// retorna true se o diret�rio ou arquivo do objeto File existe, falso o
		// contr�rio
